<h2><a href="https://practice.geeksforgeeks.org/problems/check-for-bst/1?page=1&sortBy=submissions&searchQuery=bst">Check for BST</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given the root of a&nbsp;binary tree. Check whether it is a BST or not.<br>
